...
function bindData(data) {
    ...
    if (data.Lir == 0.05) {
	    ...
	    $("#obtaino").attr("name", "0.5");
    } if (data.Lir == 0.08) {
        $("#rll").val("8%");
        $("#rll").attr("name", 0.08);
		$("#obtaino").attr("name", "0.8");
    } if (data.Lir == 0.1) {
        $("#rll").val("10%");
        $("#rll").attr("name", 0.1);
		$("#obtaino").attr("name", "0.1");
    } if (data.Lir == 0.2) {
        $("#rll").val("20%");
        $("#rll").attr("name", 0.2);
		$("#obtaino").attr("name", "0.2");
    }
...
$(function () {
    ...
    $("#ranglilv").on("click", function () {
        ...
        layer.open({
            ...
            '<div name="0.2" SortId="4" class="rlv">20%</div></div>'
        });
